...
export const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  {
    id: "resort-jeddah",
    label: "Beach resort in Jeddah",
    city: { id: 2, displayName: "Jeddah, Saudi Arabia", cityName: "Jeddah", countryName: "Saudi Arabia", countryCode: "SA", lat: 21.4858, lon: 39.1925 },
    archetype: "accommodation",
    product: "Resort / beach hotel",
    objective: "Should we develop a new beach resort in Jeddah?",
  },
  {
    id: "conference-abu-dhabi",
    label: "Global tourism conference in Abu Dhabi",
    city: { id: 1, displayName: "Abu Dhabi, United Arab Emirates", cityName: "Abu Dhabi", countryName: "United Arab Emirates", countryCode: "AE", lat: 24.4539, lon: 54.3773 },
    archetype: "mice",
    product: "Global Tourism Summit — Convention / trade show",
    objective: "Should we bid to host a global tourism industry convention in Abu Dhabi?",
  },
];
